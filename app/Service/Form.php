...
//    return $this->arround('<input type="text" id="'.$name.'" name="'.$name.'" value="'.$this->getValue($name,$data).'">');
    ...
    * @return string
    */
   public function textarea($name, $data = null, $rows = 8)
   {
//      return $this->arround('<textarea name="'.$name.'">'.$this->getValue($name,$data).'</textarea>');
      return '<textarea name="'.$name.'" rows="'.$rows.'">'.$this->getValue($name,$data).'</textarea>';
   }
   ...
   {  return '<input type="file" name="'.$name.'" id="'.$name.'" value="">';
   }
